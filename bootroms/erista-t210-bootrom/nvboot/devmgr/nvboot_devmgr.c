...
{   
...
#if NVENABLE_NAND_SUPPORT
    {
        ...
        NvBootNandShutdown,
        NvBootNandGetReaderBuffersBase
    },
#else
    { 0, 0, 0, 0, 0, 0, 0 },
#endif
    {
        /* Callbacks for the SyncNOR device */
        ...
        NvBootSnorShutdown,
        NvBootSnorGetReaderBuffersBase
    },
    {
...
#if NVENABLE_XUSB_SUPPORT
    {
        ...
        NvBootUsb3ReadPage,
        NvBootUsb3QueryStatus,
        NvBootUsb3Shutdown,
        NvBootUsb3GetReaderBuffersBase
    },
#else
    { 0, 0, 0, 0, 0, 0, 0 },
#endif
