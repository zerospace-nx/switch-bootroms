...
/*
 * nvboot_mux_one_nand_int.h - Public definitions for using MuxOne nand as the
 * second level boot device.
 */

#ifndef INCLUDED_NVBOOT_MUX_ONE_NAND_INT_H
#define INCLUDED_NVBOOT_MUX_ONE_NAND_INT_H
...
NvBootMuxOneNandInit(
    const NvBootMuxOneNandParams *ParamData,
    NvBootMuxOneNandContext *Context);
...
#endif /* #ifndef INCLUDED_NVBOOT_MUX_ONE_NAND_INT_H */
