...
#define NVBOOT_DEFAULT_BOOT_SECURITY_AUTH_INFO 0
#define NVBOOT_DEFAULT_BOOT_SECURITY_ENCRYPT_INFO 0
#define NVBOOT_DEFAULT_BOOT_SECURITY_INFO 0
#define NVBOOT_DEFAULT_BOOT_SECURITY_ODM_FUSE_ENCRYPTION_INFO 0
...
#define NVBOOT_DEFAULT_FORCE_DEBUG_RCM_STRAP NV_FALSE
#define NVBOOT_DEFAULT_DEV_SEL_STRAP             NvBootStrapDevSel_Emmc_x8_BootModeOff_26Mhz
...
#define NVBOOT_DEFAULT_RESERVED_PRODUCTION_FUSE    0
...
// Default RCM port Synopsys
#define NVBOOT_DEFAULT_RCM_PORT 0
...
// Factory secure provisioning defines
#define NVBOOT_DEFAULT_SECURE_PROVISION_INDEX 0
#define NVBOOT_DEFAULT_SECURE_PROVISION_INFO 0 // bit 0 is key_hide
                                               // bit 1 is test_part
